...
type Authentication interface {
	Authenticate(request model.AutenticationRequest)(response model.AutenticationResponse, err error)
}
...
func (this *Authentication_)Authenticate(request model.AutenticationRequest)(response model.AutenticationResponse, err error)  {
...
type AuthenticationFB interface {
	Authenticate(request model.AutenticationFBRequest)(response model.AutenticationFBResponse, err error)
}
...
func (this *AuthenticationFB_)Authenticate(request model.AutenticationFBRequest)(response model.AutenticationFBResponse, err error){
